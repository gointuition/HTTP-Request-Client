...
const Error ERR_REQUEST_INCORRECT_CONTENTLENGTH_MISMATCH            = { "2-0017", "The value of request header content-length does not match the actual payload byte length."};
const Error ERR_REQUEST_UNSUPPORTED_METHOD                          = { "2-0008", "Unsupported method, GET, POST, PUT, PATCH and DELETE supported only."};
